          ...
          <div className="log_box">
            <form onSubmit={this.handleSubmit}>
              <div className="in_ty1">
                ...
                <input type="text" id="email_val" name="email" placeholder="이메일" onChange={this.handleSubmit} 
                />
              </div>
              <div className="in_ty1">
                <span>
                ...
                <input type="password" id="pwd_val" name="password" placeholder="비밀번호" onChange={this.handleSubmit} 
                />
              </div>
              <ul className="af">
                <li>
